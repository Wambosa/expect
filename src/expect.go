...
func (tc *TestCase) Truthy() (bool) {
    ...
    if !r && tc.T != nil {tc.T.Errorf("Expect Truthy: true | actual: %v\n", tc.Value)}
...
func (tc *TestCase) Falsy() (bool) {
    ...
    if !r && tc.T != nil {tc.T.Errorf("Expect Falsy: false | actual: %v\n", tc.Value)}
...
func (tc *TestCase) ToBe(value interface{}) (bool) {
    ...
    if !r && tc.T != nil {tc.T.Errorf("Expect ToBe: %v | actual: %v\n", value, tc.Value)}
